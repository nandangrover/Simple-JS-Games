	...
	function drag()
	{
		...
		var offsetY=0;
       var d=false;
		this.addShape=function(a,b,x,y,w,h,color,d,e)
		{
			if(d==true)
			{
              offsetX = c.offsetLeft;
               ...
               var mx = e.clientX-offsetX;
		       var my = e.clientY-offsetY;
		       shapes.push({x:mx,y:my,w:w,h:h,color:color,id:id,selected:false,priority:10})
              obj1.draw(a,b,mx,my,w,h,color);
			}
			else if(d==false)
			{
	...
	function init()
	{
		var obj=new drag();
            ...
            obj.addShape(false,0,200,20,30,30,"rgb(57,255,20)",true,e)
			});
		obj.addShape(false,0,20,20,200,100,"rgb(255,0,0)",false)
		//obj.addShape(130,20,120,100,"skyBlue")
		obj.addShape(false,0,200,20,200,100,"rgb(0,0,0)",false)
		obj.addShape(false,0,200,50,200,100,"rgb(0,0,255)",false);
		obj.addShape(false,0,200,50,200,100,"rgb(0,100,155)",false);
		obj.addShape(false,0,200,50,200,100,"rgb(55,100,100)",false);
